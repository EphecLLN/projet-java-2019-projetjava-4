...
String[] nomsDesColonnes = {"MATIERE","MOYENNE","COEFFICIENT","TOTAL","APPRECIATION"};
...
BD connexion = new BD();
connexion.etablirConnexion();	
String requete = "SELECT coefficient,AVG(valeur)*coefficient FROM matieres,notes " 
...
if(i == 1) totalCoefficients +=  Integer.parseInt(jeuEnregistrements.getString(i));
...
this.conteneurPrincipal.add(new JLabel("TOTAL COEFFICIENTS : "+totalCoefficients
+"                       TOTAL MOYENNES PONDEREES : "+totalMoyennesCoefficiees
+"                       MOYENNE GENERALE : "+new DecimalFormat("0.00").format(totalMoyennesCoefficiees/totalCoefficients)
+"                       RANG : X ème"));
